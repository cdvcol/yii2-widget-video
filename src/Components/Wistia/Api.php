...
namespace Cacko\Yii2\Widgets\Video\Components\Wistia;
...
class Api extends Component
{
    ...
    {
        $this->client = new Client(['base_uri' => 'https://fast.wistia.com/']);
        parent::init();
    }
    ...
    {
        $res = $this->get('oembed',  [
            'url' => sprintf('https://support.wistia.com/medias/%s', $id),
            'embedType' => 'async',
